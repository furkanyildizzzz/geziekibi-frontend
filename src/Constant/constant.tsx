...
export const StarColorTwo = "#FFAE1A";
...
export const SearchDunzo: string = "Search Dunzo ..";
...
export const MonthlyTarget: string = "Monthly Target";
...
export const DunzoAppLaunch: string = "Dunzo App Launch";
...
export const Contact: string = "Contacts";
...
export const DefaultCheckboxLabel: string = "Default checkbox";
...
export const ImagesWithCheckboxTitle: string = "Images with checkbox";
...
export const DefaultSwitch: string = "Default switches";
...
export const LinkedInPlaceholder: string = "https://linkedIn.com/dunzo";
export const GitHubPlaceholder: string = "https://github.com/dunzo";
export const TwitterPlaceholder: string = "https://twitter.com/dunzo";
...
export const DunzoMail: string = "dunzo@example.com";
...
export const FontSize: string = "FontSize";
...
export const UnorderedList: string = "Unordered list";
...
export const EmText: string = "This line rendered as italicized text.";
...
export const HelperClasses: string = "Helper Classes";
...
export const AdditivesRadius: string = "Additive Radius";
...
export const OpenModalForDunzo: string = "Open modal for Dunzo";
...
export const DunzoCustomModal: string = "Dunzo Custom Modals ";
...
export const DunzoSignUp: string = "Dunzo SIGN-UP";
export const DunzoLogin: string = "Dunzo Login";
...
//Ui Kits- Popover
export const Popover: string = "Popover";
...
export const TooltipInfo: string = "Tooltip Info";
...
//Ui Kits- Tabs
export const ReactstrapTabs: string = "Reactstrap Tabs";
...
export const DunzoProfilesForNewEmployees: string =
  "Dunzo Profiles For New Employees:";
...
export const ListsWithCheckboxTitle: string = "Lists With Checkbox";
...
export const DunzoTheme: string = "Dunzo Theme";
...
export const SingleBlogHeading: string = `The Harped rises in the westernmost part of Rutherford County, just to the east of the community of College Grove in eastern Williamson County.`;
...
export const DisplayCategory: string = "Display Category";
...
export const CreateNewTagHeading: string = "Create New Tag";
export const EditTagHeading: string = "Edit Tag";
