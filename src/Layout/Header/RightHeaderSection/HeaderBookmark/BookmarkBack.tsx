...
import { handleBookmarkChange, setBookmark, setFlip } from "@/Redux/Reducers/HeaderBookmarkSlice";
    ...
    <div className="back">
      <ul>
              ...
              <div key={i} className="ProfileCard u-cf">
                ...
                <div className="ProfileCard-details">
                  <div className="ProfileCard-realName">
                    <Link href={Href} color="transparent" className="realname">{item.title}</Link>
        ...
        <li onClick={handleBackButton}>
          <Button tag="a" color="transparent" className="txt-primary f-w-700 d-block flip-back" id="flip-back">{Back}</Button>
        </li>
      </ul>
    </div>
  );
